...
//   document.getElementById("name1").style.background = color;
// }
...
for (var i = 0; i < weyy.length; i++) {
  ...
  weyy[i].classList.remove('white');
  weyy[i].classList.add('wey');
}
var ovv = document.getElementById("overview");
ovv.classList.add("wey");
